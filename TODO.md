...
| D5 | Full-gamut MRGPU framework (Adobe Character Animator **back-burner**) | `docs/roadmap/FULL_GAMUT_…` |
...
| D8 | I2V **Grok vs MRGPU** provenance incident closed in process | `docs/operations/I2V_GROK_VS_MRGPU_…` |
| D9 | MRGPU Comfy stills + **AnimateDiff** generative smoke (GPU 100%) | `docs/reports/MRGPU_LOCAL_RENDER_…` |
...
| **12** | Optional GH Release + attach **MRGPU** mp4 (prefer local proof over hybrid) | asset not git blob; body gets wait-what pass first |
...
- Claiming cloud I2V as “MRGPU local”
