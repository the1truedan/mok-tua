# Full-gamut MRGPU creative stack — mok-tua framework

**Date:** 2026-08-05  
**Status:** approved earmark framework (Adobe Character Animator **back-burner**)  
**Control stamp:** `2026.08-mok-tua-full-gamut-mrgpu-framework`
...
| ComfyUI MRGPU | `extra_model_paths.yaml` → `base_path: /mnt/ai-data/models/` |
...
```bash
# On MRGPU — shared models, offline if hub already seeded
...
- `config/pinokio_mrgpu_staging.json` (`framepack_studio.shared_models`)  
