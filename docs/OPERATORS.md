...
# live tier pulls (O'Reilly mode) + gpu-host progress strip
python3 scripts/mok_tua_cli.py pull --tier T0_orchestrators --live --monitor gpu-host
python3 scripts/mok_tua_cli.py pull --tier T1_vid_gen --live --monitor gpu-host
python3 scripts/mok_tua_cli.py pull --tier T2_audio_music --live --monitor gpu-host
python3 scripts/mok_tua_cli.py pull --tier T3_face_body --live --monitor gpu-host
python3 scripts/mok_tua_cli.py pull --all-bleed --live --monitor gpu-host
...
python3 scripts/mok_tua_cli.py lock load demo --live --monitor gpu-host
```
...
python3 scripts/mok_tua_cli.py pull <id> --live --monitor gpu-host
python3 scripts/mok_tua_cli.py smoke --tiers T0-T4
