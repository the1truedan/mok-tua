# gpu-host local render smoke — M.A.N.A.G.E.R. (2026-08-05)
...
| **This run** `manager_gpu-host_local_render_20260805` | **ComfyUI on gpu-host** stills + **AnimateDiff** video | **Yes** | Receipt below |
...
Timestamps (UTC) in `receipts/gpu-host_local_render.json`.
...
| `…/clips/animatediff_manager_gpu-host_ad_00001.mp4` | **gpu-host AnimateDiff** generative video |
| `…/clips/manager_gpu-host_stills_kenburns_cpu_stitch.mp4` | CPU preview of stills (labeled non-GPU) |
| `…/receipts/gpu-host_local_render.json` | Full machine receipt |

Staging root:  
`/Volumes/ai-data/work/social-staging/2026-08/manager_gpu-host_local_render_20260805/`
