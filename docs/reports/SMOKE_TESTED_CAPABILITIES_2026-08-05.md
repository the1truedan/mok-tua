...
**Policy:** accuracy over montage · never label cloud I2V as MRGPU local
...
| MRGPU Comfy still (DreamShaper_8) | **PASS** | CEO storyboard hybrid · GPU util samples peak **100%** |
...
|-------|----------|-------|------|-------|
| `example-storyboard-sheet.jpg` | `mrgpu_comfy_storyboard_hybrid` | DreamShaper_8_pruned | gpu-host | Replaces woman instructor sheet; CEO context |
| `example-face-polish.jpg` | `mrgpu_comfy_img2img_face_polish` | DreamShaper_8_pruned | gpu-host | BEFORE=source still · AFTER=denoise≈0.28 |
| `ceo-i2v-frame-strip.jpg` | `mrgpu_comfy_animatediff` | DS8 + mm_sd_v15_v2.fp16 | gpu-host | From AD mp4; not git blob video |
