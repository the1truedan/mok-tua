# Incident — I2V provenance ambiguity (Grok Imagine vs gpu-host local)
...
| D | Corrective smoke `manager_gpu-host_local_render_20260805` | **Comfy stills + AnimateDiff** on **RTX 4060 Ti**, ~48 s e2e, GPU peak **100%** |
...
| Public flip narrative | Medium — hybrid clip is valid **QQQ1 cloud** evidence, not gpu-host proof |
...
| **gpu-host generative** | `work/social-staging/2026-08/manager_gpu-host_local_render_20260805/` | Comfy + AnimateDiff · receipt `receipts/gpu-host_local_render.json` |
| Report (local) | `docs/reports/gpu-host_LOCAL_RENDER_SMOKE_2026-08-05.md` | Corrective |
...
1. Dual-path docs: hybrid vs gpu-host labeled; hybrid banner says **not gpu-host**.  
...
```text
renderer:   gpu-host_comfy_animatediff | gpu-host_comfy_wan | gpu-host_framepack | grok_imagine_i2v | ffmpeg_kenburns | other
qqq:        QQQ0 | QQQ1
