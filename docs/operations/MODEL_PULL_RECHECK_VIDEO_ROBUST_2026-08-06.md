...
| Qwen Image **Edit** 2509 fp8 | **PRESENT** (~**20 GB**) — host-local gpu-host download+promote 2026-08-06 · `local_qwen_edit` inventory **6/6** |
...
| P2 | Inkling / DeepSeek-V4-Flash | 100–180 G+ | **high-RAM host only** — not gpu-host 16 G day-0 |
...
| **Practical gpu-host coding today** | Ollama tags already present (`qwen3-coder:30b`, `qwen2.5-coder:14b`, …) via LiteLLM |
