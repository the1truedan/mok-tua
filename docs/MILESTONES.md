...
- `~/grokcode/data/catalog/comfy_gpu-host_full_stack_2026-08-02.json`
...
- `docs/reports/gpu-host_LOCAL_RENDER_SMOKE_2026-08-05.md` · `docs/reports/PINOKIO_GAMUT_SMOKE_2026-08-05.md`
