...
0.5.6: CEO gpu-host assets + FaceID pool + Wan inventory + FramePack partial I2V on private GH.
Storage: local SSD scratch → promote to /ai-data; bees settled only; NFS uid 501 vs 1000.
Grok I2V ≠ gpu-host local. FramePack mp4 finalize next; Director register Comfy; human public flip only.
```
